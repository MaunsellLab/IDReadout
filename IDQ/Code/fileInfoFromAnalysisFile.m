...
% parentFileName = '';
  ...
  nTrials = sessionProbeHeader.nTrials';
  nNoiseTrials = sessionProbeHeader.nNoiseTrials';
  parentFileName = sessionProbeHeader.parentFileName';
  parentProbeDirectionsDeg = sessionProbeHeader.parentProbeDirectionsDeg';
  parentNProbeDirections = sessionProbeHeader.parentNProbeDirections;
  parentIsSingleProbe = parentNProbeDirections == 1;
  parentIsInterleavedProbe = parentNProbeDirections > 1;
  prefCohNoisePC = sessionHeader.prefCohNoisePC;
