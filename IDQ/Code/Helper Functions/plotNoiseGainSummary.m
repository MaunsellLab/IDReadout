...
for i = 1:numel(gainFits)
  ...
  plot(ax, [x(i) x(i)], gf.CI95, 'k-', ...
    'LineWidth', 1.4, ...
    'HandleVisibility', 'off');

  plot(ax, x(i), gf.gain, 'ko', ...
    'MarkerFaceColor', 'k', ...
    'MarkerSize', 6, ...
    'DisplayName', labels{i});
end

yline(ax, noiseGain.rect.flatPrediction, 'k--', ...
...
allY = [ ...
  0, ...
  noiseGain.rect.flatPrediction, ...
  noiseGain.rect.gain, noiseGain.rect.CI95, ...
...
txt = sprintf([ ...
  ...
  'LOO z-flat %.2f'], ...
  noiseGain.rect.gain, ...
  noiseGain.rect.zVsFlat, ...
  noiseGain.looKernel.gain, ...
  noiseGain.looKernel.zVsFlat);
