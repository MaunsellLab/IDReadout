function gainFit = fitIDQNoiseGainRect(trialTable, sessionFits, alignedWeibull, targetPerformance)
% fitIDQNoiseGainRect
%
...
xNoise = double(trialTable.rectNoisePredictor(idx));
...
gainFit = struct();
gainFit.model = 'Weibull(stepCoh + gain * rectNoisePredictor)';
gainFit.predictor = 'rectNoisePredictor';
