...
if isfield(probeHeader,'parentFileName')
  candidates(end+1) = string(probeHeader.parentFileName); %#ok<AGROW>
end
if isfield(sessionHeader,'fileName')
  candidates(end+1) = string(sessionHeader.fileName); %#ok<AGROW>
end
if isfield(probeHeader,'sessionID')
  candidates(end+1) = string(probeHeader.sessionID); %#ok<AGROW>
end
