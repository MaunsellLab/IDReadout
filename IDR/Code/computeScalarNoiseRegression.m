...
valid = isfinite(correct) & ...
        isfinite(DchangePref) & ...
        isfinite(DnoChangePref) & ...
        isfinite(DdiffPref) & ...
        isfinite(DchangeProbe) & ...
        isfinite(DnoChangeProbe) & ...
        isfinite(DdiffProbe);
...
% Probe-only models.
models.changeProbe = fitglm(T, 'correct ~ DchangeProbe', ...
  'Distribution', 'binomial', 'Link', 'logit');
models.noChangeProbe = fitglm(T, 'correct ~ DnoChangeProbe', ...
  'Distribution', 'binomial', 'Link', 'logit');
models.bothProbe = fitglm(T, 'correct ~ DchangeProbe + DnoChangeProbe', ...
  'Distribution', 'binomial', 'Link', 'logit');
models.diffProbe = fitglm(T, 'correct ~ DdiffProbe', ...
  'Distribution', 'binomial', 'Link', 'logit');
...
bPref  = localModelBeta(models.changePrefProbe, 'DchangePref');
bProbe = localModelBeta(models.changePrefProbe, 'DchangeProbe');
bPrefZ  = localModelBeta(models.zChangePrefProbe, 'ZchangePref');
bProbeZ = localModelBeta(models.zChangePrefProbe, 'ZchangeProbe');

reg = struct();
reg.coeffRatios.changeProbeOverPref_z = bProbeZ / bPrefZ;
reg.coeffRatios.changeProbeOverPref_raw = bProbe / bPref;
